...
const U_int8_t PicopixelBitmaps[] SEDHOM_Flash = {
...
const SEDHOM_GFXglyph PicopixelGlyphs[] SEDHOM_Flash = {{0, 0, 0, 2, 0, 1},     // 0x20 ' '
                                            {0, 1, 5, 2, 0, -4},    // 0x21 '!'
                                            {1, 3, 2, 4, 0, -4},    // 0x22 '"'
                                            {2, 5, 5, 6, 0, -4},    // 0x23 '#'
                                            {6, 3, 6, 4, 0, -4},    // 0x24 '$'
...
const SEDHOM_GFXfont Picopixel SEDHOM_Flash = {(U_int8_t *)PicopixelBitmaps,
                                   (SEDHOM_GFXglyph *)PicopixelGlyphs, 0x20, 0x7E, 7};
