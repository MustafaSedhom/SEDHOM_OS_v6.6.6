...
const U_int8_t FreeSevenSegNumFontPlusPlusBitmaps[] SEDHOM_Flash = {
    // 7x7 [0x2E '.']
...
const SEDHOM_GFXglyph FreeSevenSegNumFontPlusPlusGlyphs[] SEDHOM_Flash = {
    {   0,  7,  7, 32, 14, -12 }, // 0x2E '.'
    {   7,  0,  0, 32, 32, -50 }, // 0x2F '/'
...
const SEDHOM_GFXfont FreeSevenSegNumFontPlusPlus SEDHOM_Flash = {
    (U_int8_t  *)FreeSevenSegNumFontPlusPlusBitmaps,
    (SEDHOM_GFXglyph *)FreeSevenSegNumFontPlusPlusGlyphs,
    46, 59, 50
};
