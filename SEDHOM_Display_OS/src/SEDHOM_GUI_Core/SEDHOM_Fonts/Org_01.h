...
const U_int8_t Org_01Bitmaps[] SEDHOM_Flash = {
...
const SEDHOM_GFXglyph Org_01Glyphs[] SEDHOM_Flash = {{0, 0, 0, 6, 0, 1},     // 0x20 ' '
                                         {0, 1, 5, 2, 0, -4},    // 0x21 '!'
                                         {1, 3, 1, 4, 0, -4},    // 0x22 '"'
                                         {2, 5, 5, 6, 0, -4},    // 0x23 '#'
                                         {6, 5, 5, 6, 0, -4},    // 0x24 '$'
...
const SEDHOM_GFXfont Org_01 SEDHOM_Flash = {(U_int8_t *)Org_01Bitmaps,
                                (SEDHOM_GFXglyph *)Org_01Glyphs, 0x20, 0x7E, 7};
