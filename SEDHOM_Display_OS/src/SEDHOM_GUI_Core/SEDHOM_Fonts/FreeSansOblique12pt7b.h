...
const U_int8_t FreeSansOblique12pt7bBitmaps[] SEDHOM_Flash = {
...
const SEDHOM_GFXglyph FreeSansOblique12pt7bGlyphs[] SEDHOM_Flash = {
    {0, 0, 0, 7, 0, 1},         // 0x20 ' '
    {0, 6, 18, 7, 3, -17},      // 0x21 '!'
    {14, 6, 6, 9, 4, -16},      // 0x22 '"'
...
const SEDHOM_GFXfont FreeSansOblique12pt7b SEDHOM_Flash = {
    (U_int8_t *)FreeSansOblique12pt7bBitmaps,
    (SEDHOM_GFXglyph *)FreeSansOblique12pt7bGlyphs, 0x20, 0x7E, 29};
