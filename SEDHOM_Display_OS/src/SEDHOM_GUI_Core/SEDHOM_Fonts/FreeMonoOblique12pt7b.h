...
const U_int8_t FreeMonoOblique12pt7bBitmaps[] SEDHOM_Flash = {
...
const SEDHOM_GFXglyph FreeMonoOblique12pt7bGlyphs[] SEDHOM_Flash = {
    {0, 0, 0, 14, 0, 1},        // 0x20 ' '
    {0, 4, 15, 14, 6, -14},     // 0x21 '!'
    {8, 8, 7, 14, 5, -14},      // 0x22 '"'
...
const SEDHOM_GFXfont FreeMonoOblique12pt7b SEDHOM_Flash = {
    (U_int8_t *)FreeMonoOblique12pt7bBitmaps,
    (SEDHOM_GFXglyph *)FreeMonoOblique12pt7bGlyphs, 0x20, 0x7E, 24};
