...
//JJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJ
class SEDHOM_Draw_Terminal : private SEDHOM_Draw_Text , private SEDHOM_Font_definations , private SEDHOM_Text_Style
{
    private:
        ///////// terminal private settings //////////
        SEDHOM_Font_definations Fonts;
        const char* start_folder_path = "Root";
        ...
        Color_t start_msg_color = Color_Green;
        // private functions
        void Init_path();
    ...
    public:
        ...
        //Terminal functions
        void Draw_Init_Terminal();
        void Draw_Clear_Terminal();
        void Draw_path();
        void Draw_Change_all_path(char* new_path);
        void Draw_Add_folder_to_path(char* folder_name);
        void Draw_Remove_folder_from_path();
        void Draw_User_Command(char* command);
        void Draw_Answer_Command(char* answer, bool is_wrong_answer = false);
};
//JJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJ
