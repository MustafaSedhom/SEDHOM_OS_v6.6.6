...
const U_int8_t FreeSmallFontBitmaps[] SEDHOM_Flash = {
// 0x0 [0x20 '.']
...
const SEDHOM_GFXglyph FreeSmallFontGlyphs[] SEDHOM_Flash = {
    {   0,  0,  0,  8,  8, -12 }, // 0x20 ' '
    {   0,  1,  8,  8,  2, -10 }, // 0x21 '!'
    {   1,  4,  3,  8,  1, -11 }, // 0x22 '"'
    {   3,  6,  8,  8,  0, -10 }, // 0x23 '#'
...
const SEDHOM_GFXfont FreeSmallFont SEDHOM_Flash = {
    (U_int8_t  *)FreeSmallFontBitmaps,
    (SEDHOM_GFXglyph *)FreeSmallFontGlyphs,
    32, 126, 12
};
// FreeSmallFont bitmap size = 414 [1079] [1239]
const U_int8_t FreeBigFontBitmaps[] SEDHOM_Flash = {
// 0x0 [0x20 '.']
...
const SEDHOM_GFXglyph FreeBigFontGlyphs[] SEDHOM_Flash = {
    {   0,  0,  0, 16, 16, -16 }, // 0x20 ' '
    {   0,  5, 13, 16,  4, -14 }, // 0x21 '!'
    {   9,  9,  5, 16,  4, -15 }, // 0x22 '"'
...
const SEDHOM_GFXfont FreeBigFont SEDHOM_Flash = {
    (U_int8_t  *)FreeBigFontBitmaps,
    (SEDHOM_GFXglyph *)FreeBigFontGlyphs,
    32, 126, 16
};
// FreeBigFont bitmap size = 1198 [1863] [3139]
const U_int8_t FreeSevenSegNumFontBitmaps[] SEDHOM_Flash = {
// 27x46 [0x30 '0']
...
const SEDHOM_GFXglyph FreeSevenSegNumFontGlyphs[] SEDHOM_Flash = {
...
const SEDHOM_GFXfont FreeSevenSegNumFont SEDHOM_Flash = {
    (U_int8_t  *)FreeSevenSegNumFontBitmaps,
    (SEDHOM_GFXglyph *)FreeSevenSegNumFontGlyphs,
    48, 57, 50
};
